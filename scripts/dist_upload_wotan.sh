...
$EXECDIR/../../Artemis/scripts/artemis_version_increment.pl $EXECDIR/../lib/Artemis/Model.pm
cd $EXECDIR/..
...
ssh artemis@wotan 'echo "/home/artemis/perl510/bin/cpansite install Artemis::Model" | bash -l'
